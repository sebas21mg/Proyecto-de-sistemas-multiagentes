...
def getCars():
    ...
    if request.method == 'GET':
        ...
        carsPos = [{"id": str(agent.unique_id), "x": x, "y": 1, "z": z - 1} for agents, (x, z) in randomModel.grid.coord_iter() for agent in agents if isinstance(agent, Car)]
...
def getObstacles():
    ...
    if request.method == 'GET':
        ...
        obstaclesPos = [{"id": str(agent.unique_id), "x": x, "y": 1, "z": z - 1} for agents, (x, z) in randomModel.grid.coord_iter() for agent in agents if isinstance(agent, Obstacle)]
...
def getTrafficLights():
    ...
    if request.method == 'GET':
        ...
        trafficLightsPos = [{"id": str(agent.unique_id), "x": x, "y": 1, "z": z - 1} for agents, (x, z) in randomModel.grid.coord_iter() for agent in agents if isinstance(agent, Traffic_Light)]
...
def getRoad():
    ...
    if request.method == 'GET':
        ...
        roadPos = [{"id": str(agent.unique_id), "x": x, "y": 1, "z": z - 1} for agents, (x, z) in randomModel.grid.coord_iter() for agent in agents if isinstance(agent, Road)]
...
def getDestination():
    ...
    if request.method == 'GET':
        ...
        destinationPos = [{"id": str(agent.unique_id), "x": x, "y": 1, "z": z - 1} for agents, (x, z) in randomModel.grid.coord_iter() for agent in agents if isinstance(agent, Destination)]
